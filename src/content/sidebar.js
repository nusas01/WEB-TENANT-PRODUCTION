    ...
    <div className="flex w-72 flex-col fixed inset-y-0 bg-white border-r border-gray-200 shadow-sm">
      ...
      <div className="flex items-center px-4 py-2 border-b border-gray-200">
        <div className="flex items-center space-x-3">
          <img src="/image/logo_nusas_2.png" className="w-12 h-12 rounded-md flex items-center justify-center shadow-sm"/>
          <div>
        ...
        >
          ...
          <div className="flex-shrink-0 flex items-center justify-between p-6 border-b border-gray-200 bg-gradient-to-r from-gray-50 to-gray-50">
            <div className="flex items-center space-x-3 min-w-0">
              ...
              <div className="min-w-0">
                <h1 className="text-xl font-bold text-gray-900 truncate">Kasir</h1>
                <p className="text-xs text-gray-500 truncate">Admin Panel</p>
              </div>
            </div>
            <button
              onClick={() => dispatch(setIsOpen(false))}
              className="flex-shrink-0 p-2 hover:bg-white/50 rounded-lg transition-colors ml-2"
            >
            ...
            <div className="space-y-3">
              {menuItems.map((item) => (
                ...
                >
                  ...
                  />
                  <ChevronRight className={`flex-shrink-0 w-4 h-4 mr-4 transition-colors ${
          ...
          <div className="flex-shrink-0 p-6 border-t border-gray-200 bg-gray-50">
            ...
            >
              ...
              <span className="font-medium whitespace-nowrap">{loadingLogout ? 'Logging out...' : 'Logout'}</span>
            </button>
          </div>
        </div>
      </div>
