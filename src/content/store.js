...
const StoreManagementDashboard = () => {
  ...
  useEffect(() => {
    if (detailStore) {
      dispatch(fetchAllEmployees(storeIdSelected))
    }
  }, [detailStore])
  ...
  useEffect(() => {
      if (successUpdateStore) {
        setToast({
          type: "success",
          message: successUpdateStore?.success
        })
      ...
      <div className='flex-1'>
        <div className="min-h-screen bg-gray-50 p-4 lg:p-8">
          ...
          <div className='mx-auto space-y-8' style={{marginTop: headerHeight}}>
            ...
            {(Object.keys(storeInfo).length > 0 && daysDiff >= 0 && storeInfo.verified_at && Object.entries(selectedStore).length !== 0) && (
