...
const CreateEmployee = () => {
  ...
  const {successCreateEmployee, errorCreateEmployee, loadingCreateEmployee} = useSelector((state) => state.createEmployeeState)
  ...
  const validateField = (name, value) => {
    ...
    switch (name) {
      ...
      case 'gender':
        ...
        } else if (!['men', 'women'].includes(value)) {
          errorMessage = 'Jenis kelamin harus men atau women'
          newErrors.gender = errorMessage
        } else {
          ...
          <div className="bg-gray-900 px-6 py-4">
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-3">
                ...
                <h1 className="text-xl font-semibold text-white">Tambah Karyawan Baru</h1>
              </div>
            </div>
          </div>
